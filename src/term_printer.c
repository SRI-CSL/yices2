...
void pretty_print_term_exp(FILE *f, const pp_area_t *area, term_table_t *tbl, term_t t) {
  yices_pp_t printer;
...
void pretty_print_term_full(FILE *f, const pp_area_t *area, term_table_t *tbl, term_t t) {
  yices_pp_t printer;
