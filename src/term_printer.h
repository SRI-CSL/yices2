 ...
 *   - truncate = false
 */
extern void pretty_print_term_exp(FILE *f, const pp_area_t *area, term_table_t *tbl, term_t t);
extern void pretty_print_term_full(FILE *f, const pp_area_t *area, term_table_t *tbl, term_t t);
