 ...
 * with the const_idx used in bitvector polynomials).
 *
 ...
 * - we assume r is well formed: all variables of r are bitvectors
 *   of the same type
 * - type of r = type of the first variable otherwise
 */
