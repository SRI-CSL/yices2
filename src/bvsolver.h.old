...
extern void init_bv_solver(bv_solver_t *solver, smt_core_t *core,
			   egraph_t *egraph, bv_var_manager_t *vm, 
			   node_table_t *tbl);
...
extern bvsolver_interface_t *bv_solver_bv_interface(bv_solver_t *solver);
 ...
 *   in the solver.
 */
extern thvar_t bv_solver_create_bvpoly(bv_solver_t *solver, bvarith_expr_t *p, itable_t *bv_map);
 ...
 */
extern thvar_t bv_solver_create_bvlogic(bv_solver_t *solver, bvlogic_expr_t *b, itable_t *bv_map);


/*
 * Internalize the binary operation (op x y)
 */
extern thvar_t bv_solver_create_bvop(bv_solver_t *solver, bvop_t op, thvar_t x, thvar_t y);
