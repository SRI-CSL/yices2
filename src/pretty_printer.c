 ...
 */
static uint32_t line_width_for_indent(const pp_area_t *area, uint32_t indent) {
  uint32_t width;
 ...
 */
static void init_printer(printer_t *p, FILE *file, const pp_token_converter_t *converter,
                         const pp_area_t *area, pp_print_mode_t mode, uint32_t indent) {
  uint32_t next_width;
 ...
 */
static const pp_area_t default_area = {
  PP_DEFAULT_WIDTH,
  PP_DEFAULT_HEIGHT,
  PP_DEFAULT_OFFSET,
  PP_DEFAULT_STRETCH,
 ...
 */
void init_pp(pp_t *pp, const pp_token_converter_t *converter, FILE *file,
             const pp_area_t *area, pp_print_mode_t mode, uint32_t indent) {
