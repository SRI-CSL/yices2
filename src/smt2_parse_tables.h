...
static const uint8_t base[NSTATES] = {
    ...
    86,  94,  95,  88,  96,  98,  91, 100, 101,  89,
   103,  98, 104, 110, 100, 109, 113, 114, 117, 104,
   111, 117, 120, 121,
};
...
static const uint8_t check[BSIZE] = {
    ...
    46,  47,  48,  49,  50,  49,  51,  52,  54,  47,
    48,  53,  55,  53,  56,  57,  56,  58,  59,  60,
    61,  62,  63,  62,  64,  58,  64,  64,  64,  64,
