...
extern void init_smt_core(smt_core_t *s, uint32_t n, void *th,
                          const th_ctrl_interface_t *ctrl, const th_smt_interface_t *smt,
                          smt_mode_t mode);
 ...
 */
extern void smt_core_reset_thsolver(smt_core_t *s, void *th, const th_ctrl_interface_t *ctrl,
				    const th_smt_interface_t *smt);
