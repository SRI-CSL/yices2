...
enum yices_token {
  ...
  // term constructors
  TK_UPDATE, TK_FORALL, TK_EXISTS, TK_LET, 
  ...
  TK_OR, TK_AND, TK_NOT, TK_XOR, TK_IFF, TK_IMPLIES, TK_MK_TUPLE, TK_SELECT, 

  // arithmetic keywords
  TK_ADD, TK_SUB, TK_MUL, TK_DIV, TK_LT, TK_LE, TK_GT, TK_GE,

  // bitvector keywords
  TK_MK_BV, TK_BV_ADD, TK_BV_SUB, TK_BV_MUL, TK_BV_NEG, TK_BV_NOT, 
  TK_BV_AND, TK_BV_OR, TK_BV_XOR, TK_BV_NAND, TK_BV_NOR, TK_BV_XNOR, 
