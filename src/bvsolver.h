...
extern const bv_interface_t *bv_solver_bv_interface(bv_solver_t *solver);

// control and smt interfaces (used by the core and egraph)
extern const th_ctrl_interface_t *bv_solver_ctrl_interface(bv_solver_t *solver);
extern const th_smt_interface_t *bv_solver_smt_interface(bv_solver_t *solver);
...
/*
 * The core invokes these functions via the smt or ctrl interface
