 ...
 *   mode = YICES_GEN_BY_PROJ_WIDE   ---> wide projection (since 2.8.0):
 *                                        projects several model-true
 *                                        implicant cubes and returns the
 *                                        union of the projected cubes. This
 *                                        can produce broader results than
 *                                        YICES_GEN_BY_PROJ on formulas that
 *                                        admit several relevant implicant
 *                                        cubes. Recommended for CEGAR-style
 *                                        outer loops over quantifier
 *                                        prefixes.
